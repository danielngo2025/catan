...
window.SITE = {
  ...
  topics: [
    ...
    { path: "nexttoken.html", title: "Next-Token Prediction", emoji: "🔮", group: "Math & CS",
    ...
    { path: "attention.html", title: "Attention", emoji: "🔗", group: "Math & CS",
    ...
    { path: "embeddings.html", title: "Word Embeddings", emoji: "🗺️", group: "Math & CS",
    ...
    { path: "gradient.html", title: "Gradient Descent", emoji: "⛰️", group: "Math & CS",
    ...
    { path: "tokenization.html", title: "Tokenization", emoji: "✂️", group: "Math & CS",
    ...
    { path: "perceptron.html", title: "The Perceptron", emoji: "🕸️", group: "Math & CS",
    ...
    { path: "diffusion.html", title: "Diffusion Models", emoji: "🎨", group: "Math & CS",
